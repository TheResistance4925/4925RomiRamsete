...
public class RobotContainer {
  ...
  private Command generateRamseteCommand() {
    ...
    Trajectory exampleTrajectory = TrajectoryGenerator.generateTrajectory(
        ...
        List.of(
            /*new Translation2d(0.2278, 0),
            new Translation2d(.3785,.079662),
            new Translation2d(0.4145, .35475),
            new Translation2d(.3628, .4675),
           // new Translation2d(0.0817, .3613),
            new Translation2d(-0.1200, .2500),
            new Translation2d(-0.3006, .4556),
           new Translation2d(-0.238938, .6407662),
            new Translation2d(.117, .6412)  
            */        
   ...
   */
   ...
   public Command getArcadeDriveCommand() {
    return new ArcadeDrive(
        m_drivetrain, () -> 0.7*-m_controller.getRawAxis(1), () -> 0.5*m_controller.getRawAxis(0));
       
  } 
  public Subsystem getIntakeRollersSubsystem() {
    return new IntakeRoller(
      m_intakeroller,  () -> m_controller.getRawButton(1)));
